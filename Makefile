...
# icr.io/isv-saas/verify-operator-bundle:$VERSION and icr.io/isv-saas/verify-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= icr.io/isv-saas/verify-operator
...
build: generate fmt vet ## Build manager binary.
	go build -o bin/manager main.go ingress_webhook.go oidc_server.go utils.go constants.go lru_store.go
...
.PHONY: bundle-yaml
bundle-yaml: ## create the yaml file for the bundle.
	cd config/manager && $(KUSTOMIZE) edit set image controller=${IMG}
